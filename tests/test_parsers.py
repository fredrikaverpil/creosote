...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Order-independence tests: variables can be defined before or after use
        pytest.param(
            ("PREREQ_APPS = ['django']\nINSTALLED_APPS = PREREQ_APPS"),
            ["django"],
            id="variable_defined_before_use",
        ),
        pytest.param(
            ("INSTALLED_APPS = PREREQ_APPS\nPREREQ_APPS = ['django']"),
            ["django"],  # Two-pass resolution handles forward references
            id="variable_defined_after_use",
        ),
        pytest.param(
